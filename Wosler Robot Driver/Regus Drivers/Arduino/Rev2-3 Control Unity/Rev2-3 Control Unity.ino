...
int16_t Positions[6] = {(X_MIN_POS + X_MAX_POS) / 2, (Y_MIN_POS + Y_MAX_POS) / 2, (Z_MIN_POS + Z_MAX_POS) / 2, 0, 0, 0};
//int16_t prevPositions[6] = {count[0], count[1], count[2], 0, 0, 0};
int16_t prevPositions[6] = {(X_MIN_POS + X_MAX_POS) / 2, (Y_MIN_POS + Y_MAX_POS) / 2, (Z_MIN_POS + Z_MAX_POS) / 2, 0, 0, 0};
...
void setup() {
  ...
  //while(1);// end program here for now;
}
